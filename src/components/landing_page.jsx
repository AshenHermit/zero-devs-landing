...
import { AnchorLink, BlockGridRenderer, FullscreenBlock, HugeBlock } from './content_blocks';
...
export const SectionSliderBlockContainer = ({...props}) => {
  let section = useContext(SectionContext)
  
  let className = "slider-blocks-container"
...
export const SectionRenderer = ({section=defaultSectionObj})=>{
  ...
  section = Object.assign(Object.assign({}, defaultSectionObj), section)
  ...
  let sections = [
    {
      ...
      contents: <BlockGridRenderer grid={
        [
          {
            left: <SectionText>
...

    {
      ...
      contents: <BlockGridRenderer grid = {[
        {center: <SectionTitle/>},
        {contents: <SectionSliderBlockContainer>
          
        </SectionSliderBlockContainer>}
      ]}/>
    },
  ]
